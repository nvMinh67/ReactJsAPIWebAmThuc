...
const AddDishForm =()=>{
    ...
    return(
        <div className='overlay' style={{zIndex:'11111111111111111111111111111'}}>
        <div
          ...
          <div className='modalRight'>
            ...
            <div class="form-outline mb-4 mt-20">
                ...
                <div class="form-outline mb-4 mt-20">
                  ...
                  <input onChange={(e)=>setprice(e.target.value)} id="form2Example1" class="form-control" />
                </div>
                
                
                <div class="form-outline mb-4">
                  <label class="form-label" for="form2Example2">Status</label>
                  <select  defaultValue={status} onChange={(e)=>setstatus(e.target.value)} name="" id="" >
                    <option  value="yes">con</option>
